...
## webshotパッケージとは {data-autoslide="36000"}
...
## hello, webshot {data-autoslide="17000"}
...
## webshot()関数について {data-autoslide="16000"}
...
## cliprectを利用  {data-autoslide="23000"}
...
## 値を指定して切り抜き {data-autoslide="13000"}
...
## selectorを利用 {data-autoslide="28000"}
...
## その他の関数について {data-autoslide="22000"}
...
## 応用例: htmlwidgetsオブジェクトの画像化 {data-autoslide="29000"}
...
## Webページキャプチャをhtmlドキュメントへ {data-autoslide="16000"}
...
## 実行結果はこんな感じ {data-autoslide="16000"}
